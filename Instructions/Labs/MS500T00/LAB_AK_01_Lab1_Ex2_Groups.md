...
10. **[アクティブなチームとグループ]** ページで、グループのリストの上のメニュー バーに表示された **[グループの追加]** を選択します。  
...
28. これでグループ削除の効果をテストできます。 **[グループ]** のリストで、 **[Inside Sales]** グループの右側に表示される垂直の省略記号アイコン ( **[その他のアクション]** ) を選択します。 表示されるメニュー ボックスで **[チームの削除]** を選択します。 
